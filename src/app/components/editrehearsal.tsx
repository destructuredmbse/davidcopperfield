...
export default function EditRehearsal(
  ...
  const [selectedDay, setSelectedDay] = useState<day|undefined>(rehearsal?.day || undefined)
  const [selectedTimes, setSelectedTimes] = useState<time|undefined>(rehearsal?{name:rehearsal.times, start_time:rehearsal._start_time, end_time:rehearsal._end_time}:undefined)
  ...
  console.log(`editing rehearsal with id ${rehearsal?.id} ${selectedScene?.name}`)
    ...
    >
      ...
      <div className='flex flex-row items-start gap-6 text-sm bg-gray-50 p-2 rounded-lg'>
            <div className="flex flex-col gap-2">
                {!scenesLoading?<SceneSelector scene={selectedScene || undefined} scenes={_scenes as scene[]} setSceneName={setSceneName}/>:'Form loading'}
